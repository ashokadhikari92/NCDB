...
<!------ Start of the record-keep ---------->
        ...
        <div class="left-record">
         <p>If citizenship certificate is issued :<br/>
            Citizenship Certificate No, Date and District<br/>
           <tr><td>Father :</td><td>{!!$child['father_citizenship_no']!!}/{!!$child['father_citizenship_issued_date'] !!}/</td><td>{!!$child['father_citizenship_issued_district'] !!}</td></tr><br>
           <tr><td>Mother :</td><td>{!!$child['mother_citizenship_no']!!}/{!!$child['mother_citizenship_issued_date'] !!}/</td><td>{!!$child['mother_citizenship_issued_district'] !!}</td></tr></p>
        </div>
        <div class="right-record">
        <p>Local Registraters : <br/>
